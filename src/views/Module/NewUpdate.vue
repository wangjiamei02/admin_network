        ...
        <Form :model="formTop" label-position="top">
          <Row>
            <Col span="24">
              <FormItem>
                <p>编号</p>
                <Input v-model="updatelist.id" disabled></Input>
              </FormItem>
            </Col>
          </Row>
          <Row>
          ...
          <Row>
            <Col span="24">
              <FormItem>
                ...
                <Input v-model="updatelist.title"></Input>
              </FormItem>
            </Col>
          </Row>
          <Row type="flex" justify="center" :gutter="24">
          ...
          <Row>
            <Col span="24">
              <FormItem>
                ...
                <quill-editor v-model="updatelist.content" ></quill-editor>
                <!-- <Input
                  type="textarea"
                  :rows="10"
...
import { getItemize,newsUpdate } from "../../axios/api.js";
